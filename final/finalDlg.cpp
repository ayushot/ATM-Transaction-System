...
BEGIN_MESSAGE_MAP(CfinalDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(btnAddNewAccount, &CfinalDlg::OnBnClickedbtnaddnewaccount)
	ON_BN_CLICKED(btnNewTransaction, &CfinalDlg::OnBnClickedbtnnewtransaction)
END_MESSAGE_MAP()
...
void CfinalDlg::OnBnClickedbtnaddnewaccount()
{
...
void CfinalDlg::OnBnClickedbtnnewtransaction()
{
	// TODO: Add your control notification handler code here
	LOGIN dlg2;
	dlg2.DoModal();
